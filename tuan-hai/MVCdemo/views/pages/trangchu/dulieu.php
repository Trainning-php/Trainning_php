...
<head>
  ...
  <link href="./public/css/bootstrap.min.css.map" rel="stylesheet">
...
<body>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        <h1 class="masthead-heading mb-0">One Page My</h1>
        <h2 class="masthead-subheading mb-0">So Chán </h2>
...
<?php foreach ($data["datas"] as $key => $values): ?>
  ...
  <script src="./public/js/bootstrap.bundle.min.js.map"></script>
</body>

</html>
<!-- <?php print_r($data["datas"]) ?> -->
